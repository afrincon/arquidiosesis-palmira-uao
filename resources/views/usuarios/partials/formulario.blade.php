<form method="post" action="{{ url('usuarios') }}" >
  ...
  <div class="col-sm-12 col-md-12">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" name="telefono" id="inputTelefono" placeholder="Ingrese el telefono" autofocus value="{{ old('telefono') }}">
      </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="date" class="form-control" name="fecha_nacimiento" id="inputFecnaci" id="fecha_nacimiento" onchange="valfecnaci()" autofocus value="{{ old('fecha_nacimiento') }}">
      </div>
